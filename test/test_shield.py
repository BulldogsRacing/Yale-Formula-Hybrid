...
while 1:
    ...
    pad.addstr(12,0, "RegenMode:"); pad.addstr(12,20,str(speedIn))
    pad.addstr(13,0, "AutoEndurMode:"); pad.addstr(13,20,str(autoEndurMode))
    pad.addstr(14,0, "EnduranceDial:"); pad.addstr(14,20,str(enduranceDial))
    stdscr.refresh()
